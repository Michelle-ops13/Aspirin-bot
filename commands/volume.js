...
module.exports = {
  info: {
    name: "volume",
    description:
      "To change the server song queue volume" +
      "\n\n" +
      "*Support :*\n`Support us on our server Aurgon - `[here](https://discord.gg/PnrzBaYBgz)." +
      "\n\n" +
      "*Developer Server :*\n`Want you bot like this, join our official bot developer server - `[here](https://discord.gg/AJhVvvuz4g).",
    usage: "[volume]",
    aliases: ["v", "vol"]
  },
